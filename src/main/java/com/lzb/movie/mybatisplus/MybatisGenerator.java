...
public class MybatisGenerator {
    ...
    private static String[] tables=new String[]{"movie"};                  //table名字
    //private static String prefix="sc_";                     //table前缀
    private static String path=System.getProperty("user.dir");
    private static String packageName="com.lzb.movie";
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("")
                        .setUrl("jdbc:mysql://127.0.0.1:3306/movie?useUnicode=true&characterEncoding=UTF-8&serverTimezone=GMT%2B8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                        ...
                        // 自定义实体父类
                         .setSuperEntityClass("com.lzb.movie.common.base.BaseModel")
                        // 自定义实体，公共字段
                        .setSuperEntityColumns(new String[]{"create_date","update_date","id"})
                        //.setTableFillList(tableFillList)
                        // 自定义 mapper 父类
                        // .setSuperMapperClass("com.expert.common.base.BaseMapper")
                        // 自定义 service 父类
                        //.setSuperServiceClass("com.expert.common.base.BaseService")
                        // 自定义 service 实现类父类
                        //.setSuperServiceImplClass("com.expert.common.base.BaseServiceImpl")
                        // 自定义 controller 父类
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        .setParent("com.lzb.movie")// 自定义包路径
                ...
                // 至您项目 src/main/resources/template 目录下，模板名称也可自定义如下配置：
                 ...
                 //.setEntity(templatePath+"entity.java.vm")
                 //.setMapper(templatePath+"mapper.java.vm")
                 //.setXml(templatePath+"mapper.xml.vm")
